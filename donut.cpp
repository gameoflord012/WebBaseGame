...
bool Donut::init(int screenWidth, int screenHeight)
{
	...
	else
	{
		...
		//Create window
		Donut::gWindow = SDL_CreateWindow( "SDL Tutorial", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, screenWidth, screenHeight, SDL_WINDOW_SHOWN | SDL_RENDERER_PRESENTVSYNC );
